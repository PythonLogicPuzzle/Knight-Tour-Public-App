<template>
  <div class="container my-5">
    <h1 class="code-line" data-line-start="0" data-line-end="1"><a id="The_Knights_Tour_Problem_0"></a>The Knight’s Tour Problem</h1>
    <p class="has-line-data" data-line-start="1" data-line-end="2">According to Wikipedia</p>
    <blockquote>
      <p class="has-line-data" data-line-start="2" data-line-end="3">
        A <strong>knight’s tour</strong> is a sequence of moves of a knight on a chessboard such that the knight visits every square exactly once. If the knight ends on a square that is one knight’s move from the beginning square (so that it
        could tour the board again immediately, following the same path), the tour is closed; otherwise, it is open
      </p>
    </blockquote>
    <p class="has-line-data" data-line-start="4" data-line-end="5">According to me</p>
    <blockquote>
      <p class="has-line-data" data-line-start="5" data-line-end="6">It’s one of those problems that bring you hair-pulling disorder if you tried to solve it on your own instead of assigning computers to solve it</p>
    </blockquote>
    <h1 class="code-line" data-line-start="7" data-line-end="8"><a id="Warnsdorffs_Rule_7"></a>Warnsdorff’s Rule</h1>
    <p class="has-line-data" data-line-start="8" data-line-end="9">Is a simple heuristic technique for solving the Knights Tour problem. And its the used technique in this visualization.</p>
    <p class="has-line-data" data-line-start="10" data-line-end="11">It consists of two steps:</p>
    <ol>
      <li class="has-line-data" data-line-start="11" data-line-end="12">Find the list of unvisited legal knight moves from the surrounding squares.</li>
      <li class="has-line-data" data-line-start="12" data-line-end="14">Choose the one with the lowest accessibility.</li>
    </ol>
    <dl>
      <dt>Accessibility</dt>
      <dd>The accessibility of square x is the number of squares accessible from x.</dd>
    </dl>
    <h1 class="code-line" data-line-start="17" data-line-end="18"><a id="The_Fun_Facts_17"></a>The Fun Facts</h1>
    <ul>
      <li class="has-line-data" data-line-start="18" data-line-end="19">On an 8 x 8 board, it has been proven that there are 26,534,728,821,064 closed-path tours!</li>
      <li class="has-line-data" data-line-start="19" data-line-end="20">The number of open path tours is unknown until this day of age!</li>
      <li class="has-line-data" data-line-start="20" data-line-end="21">
        And above all, despite all these absurd numbers of tours, non can produce a <a href="%5Bhttps://en.wikipedia.org/wiki/Magic_square%5D(https://en.wikipedia.org/wiki/Magic_square)">magic square</a>, only
        <a href="%5Bhttps://en.wikipedia.org/wiki/Magic_square#Additive-multiplicative_magic_and_semimagic_squares%5D(https://en.wikipedia.org/wiki/Magic_square#Additive-multiplicative_magic_and_semimagic_squares)">semi-magic squares</a>!
      </li>
    </ul>
  </div>
</template>
...
.title {
  line-height: 1rem;
  font-size: 0.8rem;
  margin-bottom: 0.77999rem;
  padding-top: 0.22001rem;
  font-weight: 500;
  color: #a0aabf;
  letter-spacing: 1px;
...
@media screen and (min-width: 46.25em) {
  ...
  .menu .menu-item--save-to,
  .menu .menu-item--import-from {
    display: block;
  }
  .menu .menu-item--preview,
  .menu .menu-item--save-to.in-sidebar,
